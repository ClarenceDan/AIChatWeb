...
function DangerItems() {
  ...
  return (
    <List>
      <ListItem
        title={Locale.Settings.ChatHistory.ClearTitle}
        subTitle={Locale.Settings.ChatHistory.ClearSubtitle}
      >
        <IconButton
          text={Locale.Settings.ChatHistory.Clear}
          onClick={async () => {
            if (await showConfirm(Locale.Settings.ChatHistory.ClearConfirm)) {
